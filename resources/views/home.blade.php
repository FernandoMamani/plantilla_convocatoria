...
<head>
    ...
    <title>COMVOCATORIA - Meritos</title>
    <!-- Bootstrap -->
...
<div class="animationload"><div class="loader">Cargando...</div></div> <!-- End Preloader -->
            ...
            <div class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a href="/" class="navbar-brand">CONVOCATORIA <br> <span class="slogo">MERITOS PROFESIONAL <span></a>
                    </div><!-- end navbar-header -->
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a data-scroll href="#home" class="int-collapse-menu">Inicio</a></li>
                        <li><a data-scroll href="#features" class="int-collapse-menu">Convocatorias</a></li>
                        <li><a data-scroll href="#about" class="int-collapse-menu">Avisos</a></li>
                        <li><a data-scroll href="#services" class="int-collapse-menu">Services</a></li>
                        <li><a data-scroll href="#pricing" class="int-collapse-menu">Contactos</a></li>
                        <li><a data-scroll href="#team" class="int-collapse-menu">Equipos</a></li>
                        <li><a data-scroll href="#works" class="int-collapse-menu">Portafolio</a></li>
                        <li><a data-scroll href="#contact" class="int-collapse-menu">Registrar</a></li>
                  ...
                  <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <!-- LAYER NR. 3 -->
                         <div class="tp-caption rev-video  customin customout start"
                            ...
                            data-endspeed="300"><hr class="topline"><h2>LABORATORIOS <br> Manteniendo..</h2><hr class="bottomline">
                        </div>
                        ...
                        <!-- LAYER NR. 4 -->
                         <div class="tp-caption rev-video2 customin customout start"
                            ...
                            data-start="500"
                            data-easing="Back.easeInOut"
                            data-endspeed="300"><p> DISEÑO <br> Diseñando ...</p>
                        </div>
                    </li>
                     ...
                     <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption rev-video skewfromleft customout"
                            ...
                            style="z-index: 6"><hr class="topline"><h2>MERITOS <br> Profecional</h2><hr class="bottomline">
                        </div>
                        ...
                        <div class="tp-caption rev-video2 skewfromright customout"
                            ...
                            data-endeasing="Power1.easeIn"
                            data-captionhidden="on"
                            style="z-index: 7"><p>Posibilidades</p>
                        </div>
                    </li>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption rev-video skewfromleft customout"
                            ...
                            data-endeasing="Power1.easeIn"
                            data-captionhidden="on"
                            style="z-index: 6"><hr class="topline"><h2>CONVOCATORIA merito<br>Mas posibilidades</h2><hr class="bottomline">
                        </div>
                        ...
                        <div class="tp-caption rev-video2 skewfromright customout"
                            ...
                            data-endeasing="Power1.easeIn"
                            data-captionhidden="on"
                            style="z-index: 7"><p>Desarollando proyectos</p>
                        </div>
                    </li>
                  </ul>
    ...
    <section id="services" class="white-wrapper">
        <div class="container">
            <div class="title text-center">
                <h2>SERVICIOS</h2>
                <p>CONVOCATORIA DE CALIFICACION MERITO PROFESIONAL</p>
                <hr>
            </div><!-- end title -->
            ...
            <div class="row">
                <div data-scroll-reveal="enter from the bottom after 0.3s" class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
                    <div class="service-box">
                        ...
                        <h3>INVESTIGACIÓN CIENTIFICA</h3>
                        <p>Todo de investigacion cientifica...</p>
                    </div>
                </div>
                ...
                <div data-scroll-reveal="enter from the bottom after 0.6s" class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
                    <div class="service-box">
                        ...
                        <h3>LABORATORIOS /COMPUTOS</h3>
                        <p>Todo de laboratorio  computo...</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div data-scroll-reveal="enter from the bottom after 1.2s" class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
                    <div class="service-box">
                        ...
                        <h3>DISEÑO & DESARROLLO / MOVIL APPS</h3>
                        <p>Diseñe tus propios paginas...</p>
                    </div>
                </div>
                ...
                <div data-scroll-reveal="enter from the bottom after 1.8s" class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
                    <div class="service-box">
                        ...
                        <h3>SOCIAL</h3>
                        <p>Todo de investigacion cientifica participando...</p>
                    </div>
                </div>
            </div> <!-- end row 2 -->
    ...
    <section id="footer" class="footer-wrapper text-center">
        ...
        <p>Copyring by © 2020 <a href="http://www.createwebsite.net">Creado Com</a></p>
